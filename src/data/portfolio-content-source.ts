...
export const contentSource = {
  ...
  "resume": {
    ...
    "executiveSummary": {
      ...
      "title": "AI product builder with secure systems depth",
      "intro": "I’m a hardware hacker, security-minded builder, data dog, and 0-to-1 operator. I help teams turn messy operations, data movement, and AI ideas into secure software people can actually use.",
      "summary": "The pattern across my work is consistent: I step into ambiguous, cross-functional problems with a hacker instinct, figure out how the system really works, and turn rough ideas into secure, usable software teams actually trust and adopt.",
      "accent": "#2f6b73",
      ...
      "metrics": [
        ...
        {
          "value": "0->1",
          "label": "Secure AI tooling for non technical teams"
        },
        {
          "value": "04",
      ...
      "valuePillars": [
        {
          ...
          "description": "I can work directly with operators and subject matter experts, tighten fuzzy requirements, and ship a real first version instead of waiting for perfect inputs."
        },
        {
          "title": "Bridge product, systems, and security",
          "description": "The same builder can shape the workflow, wire the integrations, reason about permissions, and make sure the result is maintainable in production."
        },
        {
          "title": "Build AI that is grounded in reality",
          "description": "I’m interested in AI when prompts, context, tools, and interfaces form a trustworthy workflow, not when they produce demo theater."
        },
        {
          "title": "Operate with founder-level ownership",
          "description": "I like owning broad slices of work, finding the wedge, and turning recurring pain points into products or internal platforms people actually want to use."
        }
      ],
      "quickFacts": [
    ...
    "sections": [
      ...
      },
      {
        ...
        "intro": "These are the strongest public proofs of how I work: shipping AI-native interfaces, documentation and governance systems, and product ideas shaped around messy real-world workflows. They also show the founder side of how I think about ownership, positioning, and product direction.",
        ...
        "cards": [
          {
            ...
            "description": "Ludflow is my privately owned platform for AI documentation, data governance, and grounded MCP context. It grew from the recurring pain of organizations splitting knowledge across code, schemas, docs, and tribal memory, then expecting teams or AI tools to reconstruct the truth.",
            "links": [
              {
                "label": "Visit Ludflow",
          ...
          },
          {
            ...
            "description": "MCPViews is an open-source desktop companion that gives AI agents a visual interface, plugin system, and richer review flows than plain text alone. It serves as both a usable tool and a public product bet on where MCP-native software is going.",
            "links": [
              {
          ...
          },
          {
            ...
            "description": "DecidR MCP is the initiative, architecture, and approval layer in the broader Ludflow ecosystem. It reflects how I think AI-native teams should collaborate at a systems level rather than reducing everything to disconnected tickets.",
            "tags": [
              "Ludflow ecosystem",
              "Decision workflows",
              "AI-native teams",
      ...
      },
      {
        ...
        "intro": "The personal side of the work story is that I grew up taking things apart, building computers, repairing phones, and chasing whatever new technology I could get my hands on. That instinct still shapes how I approach products, systems, and problem solving.",
        "summary": "This section is less about accomplishments and more about temperament: how I work, where I create leverage, and the personal background behind the builder.",
        "accent": "#9d6335",
        ...
        "cards": [
          ...
          },
          {
            "title": "Home life now",
            "eyebrow": "Family",
            "description": "I currently live in Ogden, Utah with my wife Julie, who is a YA fantasy author, and our son Orion. We also have one more child on the way.",
            "tags": [
              "Ogden, Utah",
              "Family life",
              "Julie Janis",
