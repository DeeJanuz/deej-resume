...
export function ResumeWindowContent({ resume }: ResumeWindowContentProps) {
  ...
  return (
    <div className="resume-container h-full min-h-0">
      <div className="resume-window-layout grid h-full min-h-0 md:grid-cols-[220px_1fr]">
        <aside className="resume-window-sidebar hidden min-h-0 border-r border-stone-200 bg-stone-50 md:flex md:flex-col">
                  ...
                  return (
                    <li key={item.id}>
                      <button
                        ...
                        className="w-full rounded-lg border px-3 py-1.5 text-left text-[13px] font-medium transition focus-visible:outline-none"
                        style={{
        ...
        <div className="flex min-h-0 flex-col bg-stone-50">
          <div ref={scrollContainerRef} className="min-h-0 overflow-y-auto">
            <div className="resume-window-scroll-content space-y-4 p-4 sm:p-5">
